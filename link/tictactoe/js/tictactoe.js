...
function init(){
	...
	gc.strokeRect(100,0,100,100);
	gc.strokeRect(200,0,100,100);

	gc.strokeRect(0,100,100,100);	
	gc.strokeRect(100,100,100,100);
	gc.strokeRect(200,100,100,100);

	gc.strokeRect(0,200,100,100);	
	gc.strokeRect(100,200,100,100);
